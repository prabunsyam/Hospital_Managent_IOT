 ...
 * Generated at: 2019-03-25 13:40:29 UTC
...
public final class hospital_005freg_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<h1>Enroll your hospital</h1> \r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"login-agileits-top\"> \t\r\n");
      out.write("\t\t\t\t\t\t\t\t<form action=\"hosp_servlet\" method=\"post\"> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<p>User Name </p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"name\" name=\"user\" required=\"\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<p>Password</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"password\" class=\"password\" name=\"pass\" required=\"\"/>  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"anim\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</label>   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"submit\" value=\"Create login\"name=\"operation\"> \r\n");
      out.write("\t\t\t\t\t\t\t\t</form> \t\r\n");
      out.write("\t\t\t\t\t\t\t</div> \r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</div>  \r\n");
